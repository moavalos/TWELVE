...
VALUES
    ('Volver al Futuro', 'Un adolescente viaja accidentalmente...', '¿Carretera?...', 116.0, 2, 4500000, '1985', 'volver_al_futuro.jpg', 2, 50000, 9.0, 'Robert Zemeckis', 'Robert Zemeckis, Bob Gale', 'Inglés', 'Back to the Future, Regreso al Futuro (España)'),
    ('Apocalypse Now', 'Durante la guerra de Vietnam...', 'Me encanta...', 153.0, 2, 5000000, '1979', 'apocalypse_now.jpg', 1, 42000, 8.4, 'Francis Ford Coppola', 'John Milius, Francis Ford Coppola', 'Inglés', 'Apocalypse Now'),
    ('El Bueno, el Malo y el Feo', 'Tres hombres luchan por un tesoro...', 'Cuando se dispara...', 178.0, 6, 6000000, '1966', 'el_bueno_el_malo_y_el_feo.jpg', 2, 51000, 7.9, 'Sergio Leone', 'Sergio Leone, Luciano Vincenzoni', 'Italiano', 'The Good, the Bad and the Ugly, El Bueno, el Feo y el Malo (España)'),
    ('El Viaje de Chihiro', 'Una niña entra en un mundo de espíritus...', 'Nada de lo que...', 125.0, 5, 5000000, '2001', 'el_viaje_de_chihiro.jpg', 1, 48000, 8.6, 'Hayao Miyazaki', 'Hayao Miyazaki', 'Japonés', 'Spirited Away, El Viaje de Chihiro (España)'),
    ('Sin Novedades en el Frente', 'Un joven soldado alemán...', 'La guerra no...', 148.0, 4, 3000000, '2022', 'sin_novedades_en_el_frente.jpg', 1, 35000, 8.3, 'Edward Berger', 'Edward Berger, Lesley Paterson, Ian Stokell', 'Alemán', 'All Quiet on the Western Front, Sin Novedades en el Frente (España)'),
    ('El Origen', 'Un thriller que desafía...', 'Tienes que tener...', 148.0, 2, 5000000, '2010', 'el_origen.jpg', 1, 35000, 8.8, 'Christopher Nolan', 'Christopher Nolan', 'Inglés', 'Inception, Origen (España)'),
    ('El Caballero de la Noche', 'Cuando el Joker emerge...', '¿Por qué tan serio?', 152.0, 2, 7000000, '2008', 'el_caballero_de_la_noche.jpg', 2, 70000, 8.9, 'Christopher Nolan', 'Jonathan Nolan, Christopher Nolan', 'Inglés', 'The Dark Knight, El Caballero Oscuro (España)'),
    ('Matrix', 'Un hacker informático...', 'No hay cuchara.', 136.0, 2, 6500000, '1999', 'matrix.jpg', 2, 38000, 8.7, 'Lana Wachowski, Lilly Wachowski', 'Lana Wachowski, Lilly Wachowski', 'Inglés', 'The Matrix, Matrix (España)'),
    ('Interestelar', 'Un equipo de exploradores...', 'La humanidad nació...', 169.0, 2, 5500000, '2014', 'interestelar.jpg', NULL, 42000, 8.6, 'Christopher Nolan', 'Jonathan Nolan, Christopher Nolan', 'Inglés', 'Interstellar, Interestelar (España)'),
    ('Parásitos', 'La codicia y la discriminación...', 'Actúa como si fueras...', 132.0, 3, 4500000, '2019', 'parasitos.jpg', NULL, 40000, 8.6, 'Bong Joon-ho', 'Bong Joon-ho, Han Jin-won', 'Coreano', 'Parasite, Parásitos (España)'),
    ('Tiempos Violentos', 'Las vidas de dos sicarios...', 'Inglés, hijo de p***...', 154.0, 2, 6000000, '1994', 'tiempos_violentos.jpg', NULL, 50000, 8.9, 'Quentin Tarantino', 'Quentin Tarantino', 'Inglés', 'Pulp Fiction, Tiempos Violentos (España)');
